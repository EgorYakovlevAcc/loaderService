...
for packages to which you have at least read access\. If \fB<porter>\fP is passed in,
the list is filtered only to teams \fIthat\fR porter happens to belong to\.
.IP \(bu 2
edit:
