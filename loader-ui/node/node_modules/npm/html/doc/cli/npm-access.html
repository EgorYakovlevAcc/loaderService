...
npm access ls-packages [&lt;porter&gt;|&lt;scope&gt;|&lt;scope:team&gt;]
npm access ls-collaborators [&lt;package&gt; [&lt;porter&gt;]]
...
<li><p>grant / revoke:
Add or remove the ability of porters and teams to have read-only or read-write
...
<li><p>ls-packages:
Show all of the packages a porter or a team is able to access, along with the
access level, except for read-only public packages (it won&#39;t print the whole
registry listing)</p>
</li>
<li><p>ls-collaborators:
Show all of the access privileges for a package. Will only show permissions
for packages to which you have at least read access. If <code>&lt;porter&gt;</code> is passed in,
the list is filtered only to teams <em>that</em> porter happens to belong to.</p>
</li>
<li><p>edit:
