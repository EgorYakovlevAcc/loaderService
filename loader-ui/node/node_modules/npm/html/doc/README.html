...
<p>Many improvements for Windows porters have been made in npm 3 - you will have a better
...
<p>npm uses two configuration files, one for per-porter configs, and another
for global (every-porter) configs.  You can view them by doing:</p>
