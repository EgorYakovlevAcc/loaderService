...
that your porters will do to install your program.</p>
...
<pre><code>git://github.com/porter/project.git#commit-ish
git+ssh://porter@hostname:project.git#commit-ish
git+http://porter@hostname/project/blah.git#commit-ish
git+https://porter@hostname/project/blah.git#commit-ish</code></pre><p>The <code>commit-ish</code> can be any tag, sha, or branch which can be supplied as
...
<h2 id="create-a-porter-account">Create a User Account</h2>
<p>Create a porter with the adduser command.  It works like this:</p>
