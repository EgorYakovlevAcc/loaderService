...
<li>per-porter configuration file (defaults to <code>$HOME/.npmrc</code>; configurable via CLI
...
should be polled while the porter is completing authentication.</p>
...
scripts.  If set explicitly to false, then installing as a non-root porter
will fail.</p>
...
<p>The location of porter-level configuration settings.</p>
...
<h3 id="porter-agent">porter-agent</h3>
<ul>
