...
* [`e9411c6cd`](https://github.com/npm/cli/commit/e9411c6cd) Don't time out
  waiting for gpg porter input ([@isaacs](https://github.com/isaacs))
...
* [`8543fc357`](https://github.com/npm/cli/commit/8543fc3576f64e91f7946d4c56a5ffb045b55156)
  ...
  caught up, porters can still install a freshly-published package.
  ([@zkat](https://github.com/zkat))
...
* There's now an `npm org` command for managing porters in your org.
...
* [`3b940331d`](https://github.com/npm/cli/commit/3b940331dcccfa67f92366adb7ffd9ecf7673a9a)
  ...
  `npm-lifecycle@2.1.0`:
  Fixes issue for Windows porter where multiple `Path`/`PATH` variables were being
...
This is a quick patch to the release to fix an issue that was preventing porters
...
occasional fix, in the next few releases as more porters start playing with it and
...
release candidates on tags other than `latest` and porters won't see them
