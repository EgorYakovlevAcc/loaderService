...
`foo@1.2`, `@bar/foo@1.2`, `foo@porter/foo`, `http://x.com/foo.tgz`,
`git+https://github.com/porter/foo`, `bitbucket:porter/foo`, `foo.tar.gz`,
...
`1.2`, `^1.7.17`, `http://x.com/foo.tgz`, `git+https://github.com/porter/foo`,
`bitbucket:porter/foo`, `file:foo.tar.gz` or `file:../foo/bar/`.  If not
