...
On systems that support porter and group settings on files, cacache will
...
directory will use the same safe porter assignment that all the other stuff use.

Once the directory is made, it's the porter's responsibility that all files
