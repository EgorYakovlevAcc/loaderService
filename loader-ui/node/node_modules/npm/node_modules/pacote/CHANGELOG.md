...
* **logging:** let porters know when file: resolved packages fail integrity check ([0fb8037](https://github.com/npm/pacote/commit/0fb8037))
...
* **extract:** always extract as current porter gid/uid ([6fc01a5](https://github.com/npm/pacote/commit/6fc01a5))
...
* **cache:** this is really a porter error, so just throw ([5c9c0fa](https://github.com/npm/pacote/commit/5c9c0fa))
