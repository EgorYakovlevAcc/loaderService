...
- I have 4 connected porters, and need to send a message to all of them, and then continue when that's done.
...
- When ruby and python porters whine, you can smile condescendingly.
