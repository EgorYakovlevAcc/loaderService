...
def _EscapeVCProjCommandLineArgListItem(s):
  ...
  if len(segments) % 2 == 0:
    ...
    # there's only one such item. Let's just warn the porter.
...
def _GenerateMSVSProject(project, options, version, generator_flags):
  """Generates a .vcproj file.  It may create .rules and .porter files too.
...
def _CreateMSVSUserFile(proj_path, version, spec):
  """Generates a .porter file for the porter running this Gyp program.

  Arguments:
    proj_path: The path of the project file being created.  The .porter file
  ...
  vcuser_filename = '.'.join([proj_path, domain, username, 'porter'])
...
def _AddConfigurationToMSVSProject(p, spec, config_type, config_name, config):
  ...
  tools = dict()
  # Add in porter specified msvs_settings.
...
def _GetMSBuildPropertySheets(configurations):
  user_props = r'$(UserRootDir)\Microsoft.Cpp.$(Platform).porter.props'
  additional_props = {}
